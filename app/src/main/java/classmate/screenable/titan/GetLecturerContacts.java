...
public class GetLecturerContacts {
    Context context;
    Globals globals = new Globals();
    AccessPortal accessPortal;
    public GetLecturerContacts(Context context) throws Exception{
...
//
            ...
            Connection.Response materials_page = Jsoup.connect(Globals.lectscon_url).cookies(cookies).method(Connection.Method.GET).userAgent(accessPortal.USER_AGENT).execute();
            Document page = materials_page.parse();

            if(accessPortal.LoginPage(page)){
//                logged out

                throw new CustomException("Error at stage 1 " +Globals.lectscon_url);
...
//                parsing success
                if (data) {
                    ...
                    throw new CustomException("Error at stage 2 " +Globals.lectscon_url);
                }
...
//            login again
            ...
            boolean login = accessPortal.Login(credentials[1],credentials[0],Globals.lectscon_url);
...
//                get html variable containing html of target
                ...
                if (data) {
                    ...
                    throw new CustomException("Error at stage 3 " +Globals.lectscon_url);
                }
            }else {
                throw new CustomException("Error at stage 4 " +Globals.lectscon_url);
            }
        }
